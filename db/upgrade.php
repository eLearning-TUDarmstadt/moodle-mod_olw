...
function xmldb_olw_upgrade($oldversion) {
    global $CFG, $DB;
    ...
    if ($oldversion < 2013021400) {
        // find all courses that contain olws and reset their cache
        ...
        // olw savepoint reached
        upgrade_mod_savepoint(true, 2013021400, 'olw');
    }
